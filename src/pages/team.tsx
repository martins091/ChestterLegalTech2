...
const teamMembers = [
  ...
  // },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1494790108755-2616b612b786?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=400",
    expertise: [
      "Data Protection",
      "Privacy Law",
      "Cybersecurity",
    ...
    education: [
      ...
      "LLM Technology Law - University of Edinburgh",
  ...
  },
  {
    ...
    bio: "CJ Nwogu is a highly skilled litigator & corporate practitioner with over 10 years of experience in commercial disputes, arbitration, and intellectual property law. He has a strong record of successfully representing clients in high-stakes litigation and international arbitration proceedings. Known for his strategic thinking and exceptional advocacy skills, CJ consistently achieves favorable outcomes for his clients. Additionally, he is a certified Notary Public.",
    image:
    ...
    achievements: [
      ". NOTARY PUBIC ",
      "CERTIFICATION IN HUMANITARIAN VOLUNTEERS ",
    ],
    social: {
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed animate-fade-in-up delay-200">
              Our team combines decades of legal expertise with innovative
              thinking to deliver unparalleled results for our clients.
            </p>
          </div>
            ...
            {teamMembers.map((member, index) => (
              ...
              >
                ...
                <div className="lg:w-2/5">
                  <div
                    className={`premium-card rounded-3xl p-8 text-center ${
                      member.featured ? "bg-navy text-white" : "bg-navy"
                    }`}
                  >
                    ...
                    <h3
                      className={`text-2xl font-bold mb-2 ${
                        member.featured ? "text-white" : "text-navy"
                      }`}
                    >
                      {member.name}
                    </h3>
                    <p
                      className={`text-lg mb-6 ${
                        member.featured ? "text-gold" : "text-gold"
                      } font-semibold`}
                    >
                      {member.position}
                    </p>
                ...
                <div className="lg:w-3/5 space-y-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-white rounded-3xl p-6 shadow-lg card-hover">
                      <h5 className="text-xl font-bold text-navy mb-4">
      ...
      <section className="py-24 hero-gradient relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-white/90 mb-12 max-w-2xl mx-auto">
            Connect with our legal experts and discover how our team's combined
