...
const values = [
  {
    ...
    title: "Integrity",
    description:
      "We uphold the highest ethical standards in all our professional dealings, ensuring trust and transparency with every client.",
  },
  {
    icon: Lightbulb,
    title: "Innovation",
    description:
      "We embrace cutting-edge legal technology and forward-thinking approaches to deliver modern solutions.",
  },
  {
    icon: Users,
    title: "Client-Centric",
    description:
      "Your success is our priority. We tailor our services to meet your unique business needs and objectives.",
  },
  {
    icon: TrendingUp,
    title: "Excellence",
    description:
      "We strive for exceptional results in every matter, combining legal expertise with strategic business thinking.",
  },
  {
    icon: Globe,
    title: "Global Perspective",
    description:
      "We understand international best practices while maintaining deep knowledge of the Nigerian legal landscape.",
  },
  {
    icon: Target,
    title: "Results-Driven",
    description:
      "We focus on delivering measurable outcomes that drive your business forward and create lasting value.",
  },
];
...
const timeline = [
  {
    ...
    title: "Foundation",
    description:
      "Chestter Law was established with a vision to revolutionize legal services in Nigeria's emerging fintech sector.",
  },
  {
    year: "2017",
    title: "Fintech Focus",
    description:
      "Specialized in fintech regulations and became a trusted advisor to Nigeria's leading financial technology companies.",
  },
  {
    year: "2020",
    title: "Digital Transformation",
    description:
      "Launched innovative digital legal services and remote consultation capabilities during the global shift.",
  },
  {
    year: "2024",
    title: "Industry Leadership",
    description:
      "Recognized as Nigeria's foremost fintech-focused law firm with over 150 satisfied clients and counting.",
  },
];
...
export default function About() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-24 pb-16 hero-gradient relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto animate-fade-in-up delay-200">
            Nigeria's foremost fintech-focused law firm, pioneering innovative
            legal solutions for the modern financial technology landscape.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed mb-6">
              ...
              commercial and fintech-focused law firm. Our mission is clear: to
              be the leading commercial law firm in Fintech, IT and related core
              practice areas, providing top-notch service to our clients. For
              us, excellence means delivering innovative, value-driven solutions
              that are timely and consistently exceed our clients’ expectations.
            </p>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed mb-6">
              With a proven track record and extensive experience in the
              Nigerian legal market, we are uniquely positioned to serve both
              local and international clients looking to enter or strengthen
              their presence in the Nigerian business landscape. Whether you are
              expanding into Nigeria or looking to solidify your position, we
              bring the expertise and insight needed to navigate this dynamic
              market.
            </p>
            <h3 className="text-3xl font-bold text-navy mb-4">Our Vision</h3>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              To build an excellent firm made up of successful people.
            </p>
          </div>
        </div>
      </section>
            ...
            {stats.map((stat, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="text-4xl lg:text-5xl font-bold text-navy mb-3 animate-fade-in-up">
                    {stat.number}
                  </div>
              ...
              <div className="space-y-8">
                <div className="bg-white p-8 rounded-2xl shadow-lg card-hover">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    To provide innovative, client-centric legal solutions that
                    empower fintech companies and financial services providers
                    to navigate Nigeria's evolving regulatory landscape while
                    driving business growth and technological advancement.
                  </p>
                </div>
                ...
                <div className="bg-white p-8 rounded-2xl shadow-lg card-hover">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    To be Africa's leading fintech-focused law firm, recognized
                    for our expertise, innovation, and commitment to advancing
                    the financial technology ecosystem across the continent.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed animate-fade-in-up delay-200">
              ...
              provide, ensuring we deliver exceptional results while maintaining
      ...
      <section className="py-32 bg-gradient-to-br from-slate-50 to-white relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <div className="w-32 h-1.5 bg-gradient-to-r from-gold to-gold/70 mx-auto mb-8 rounded-full"></div>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed animate-fade-in-up delay-200">
              From our founding to becoming Nigeria's leading fintech law firm,
                ...
                >
                  ...
                  >
                    <div className="bg-white p-10 rounded-3xl shadow-2xl card-hover border border-gray-100 group">
                      <div className="text-3xl font-bold bg-gradient-to-r from-gold to-gold/80 bg-clip-text text-transparent mb-4">
                        {item.year}
                      </div>
                      <h3 className="text-2xl font-bold text-navy mb-6 group-hover:text-gold transition-colors duration-300">
                        {item.title}
      ...
      <section className="py-24 hero-gradient relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-white/90 mb-12 max-w-2xl mx-auto">
            Join the growing community of fintech innovators who trust us to
            navigate complex legal challenges and drive business success.
          </p>
      ...
      <section
        id="contact"
        className="py-32 bg-gradient-to-br from-slate-50 via-white to-slate-50 relative overflow-hidden"
      >
        <div className="absolute inset-0">
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <div className="w-32 h-1.5 bg-gradient-to-r from-gold to-gold/70 mx-auto mb-8 rounded-full"></div>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed animate-fade-in-up delay-200">
              Take the first step towards exceptional legal representation.
              Let's discuss how we can help your business thrive in the fintech
              landscape.
            </p>
          </div>
